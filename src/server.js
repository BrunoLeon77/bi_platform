...
app.get('/new-client', function (req, res) {
    res.sendFile(path.join(__dirname + '/../views/new-client.html'));
});

app.get('/edit-client', function (req, res) {
    res.sendFile(path.join(__dirname + '/../views/edit-client.html'));
});
...
app.get('/edit-user', function (req, res) {
    res.sendFile(path.join(__dirname + '/../views/edit-user.html'));
});
